...
//UTILIDADES * MUDAR COR DO TEXTO/COR DO PLANO DE FUNDO, FUNÇÃO DE COORDENADAS, FUNÇÃO PRA DESENHAR A BORDA DA JANELA,
//E FUNÇÃO PRA DESENHAR OS BOTOES
...
// convert int to string
   ...
   {
       //procura no arquivo se ja existe dados salvos do mes em q o usuario está entrando
       p=fopen(ano,"rb");
       bool achou=false;
